...
/**
  ...
  /**
   * `prisma.carSlot`: Exposes CRUD operations for the **CarSlot** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more CarSlots
    * const carSlots = await prisma.carSlot.findMany()
    * ```
    */
  get carSlot(): Prisma.CarSlotDelegate<ExtArgs, { omit: OmitOpts }>;
}
